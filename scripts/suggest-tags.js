...
function buildSystemPrompt(facets) {
  return [
    ...
    '- Prefer precision over coverage. Two tags a reader would expect are better',
    '  than five that are merely defensible. Most records need two or three in',
    '  total across all facets.',
